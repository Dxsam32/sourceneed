  ...
  return (
    <div className="border border-ink bg-paper">
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-ink bg-ink px-4 py-2.5">
        <span className="font-mono text-[0.6875rem] font-semibold uppercase tracking-[0.16em] text-paper">
          {caption}
        </span>
              ...
              {["Material", "CAS №", "Grade", "Lot qty", "Location", "Docs", "Price"].map(
                (h) => (
                  <th
                    key={h}
                    scope="col"
                    className="whitespace-nowrap px-4 py-2.5 font-mono text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-ink-soft"
                  >
                    {h}
                  </th>
                )
            ...
            {products.map((p) => (
              ...
              >
                <td className="px-4 py-3">
                  ...
                  <span className="mt-0.5 block font-mono text-[0.625rem] uppercase tracking-[0.1em] text-ink-soft">
